...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			// case 'peppermint':
				//FlxG.switchState(new VideoState('assets/videos/startCutscene/cutscene.webm', new PlayState()));
		}
			...
			case 'white':
				{
						defaultCamZoom = 0.9;
						curStage = 'white';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('whitestage'));
		...
		healthBar.createFilledBar(0xFFFF0000, FlxColor.ORANGE);
		// healthBar
		add(healthBar);
	...
	override public function update(elapsed:Float)
	{
		...
		if(curStep > 448 && curStep < 480 && PlayState.SONG.song.toLowerCase() == 'cold')
		{
			dad.playAnim("screech");
			FlxG.camera.shake(0.11, 0.03);
		}
		if(curStep > 480 && curStep < 481 && PlayState.SONG.song.toLowerCase() == 'cold')
